...
class Ip_Fitments_Block_Adminhtml_Dashboard_Widget_Top extends Mage_Adminhtml_Block_Dashboard_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        //set latest filter
        $this->_collection->setOrder('popularity', 'DESC');
